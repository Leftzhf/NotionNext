...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'LeftLeft', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的干饭人🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://leftleft.club', // 网站地址
  ...
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '桂ICP备2022008959号-1', // 备案号 闽ICP备XXXXXXX
